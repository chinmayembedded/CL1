...
int main()
{
	...
	namedWindow("Segment1", CV_WINDOW_AUTOSIZE);
	imshow("Segment1",dst[1]);
	namedWindow("Segment2", CV_WINDOW_AUTOSIZE);
	imshow("Segment2",dst[2]);
	namedWindow("Segment3", CV_WINDOW_AUTOSIZE);
	imshow("Segment3",dst[3]);
	waitKey(0);
	return 0;
}
